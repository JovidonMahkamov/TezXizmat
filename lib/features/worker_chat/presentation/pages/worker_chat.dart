...
class _WorkerChatPageState extends State<WorkerChatPage> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<ChatRoomsBloc>().add(const GetChatRoomsE()); // birinchi load
      _startPolling();
    });
  }
          ...
          listener: (context, state) {
            ...
            if (state is ChatDeleteSuccess) {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text("${state.deletedCount} ta chat o‘chirildi")),
              );
            }
  ...
  Widget _item({
    ...
    return InkWell(
      ...
      onTap: () async {
        ...
        _stopPolling(); // chatga kirganda polling to‘xtasin (ixtiyoriy, lekin yaxshi)
        ...
        // qaytganda yangilab + pollingni qayta yoqamiz
        context.read<ChatRoomsBloc>().add(const GetChatRoomsE(silent: true));
        _startPolling();
      },
      child: Row(
