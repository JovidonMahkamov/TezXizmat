...
class CustomerDioClient {
  ...
  CustomerDioClient({required this.local})
      : _dio = Dio(
    BaseOptions(
      baseUrl: CustomerApiUrls.baseUrl,
  ...
  Future<String?> _refreshTokenSafely() async {
    ...
    try {
      ...
      final refreshUrl = isStaff ? CustomerApiUrls.refreshStaff : CustomerApiUrls.refreshCustomer;
